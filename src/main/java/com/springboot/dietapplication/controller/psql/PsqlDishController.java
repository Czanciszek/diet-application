...
import com.springboot.dietapplication.service.PsqlDishService;
...
public class PsqlDishController {

    private final PsqlDishService dishService;

    public PsqlDishController(PsqlDishService dishService) {
